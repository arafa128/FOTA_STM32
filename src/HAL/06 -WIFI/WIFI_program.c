...
*							Karem Hassan                                                                                              *
*							Ahmed Emad						09 MAR,2022						-WIFI_program.c     				      *
**************************************************************************************************************************************/
...
/***************************************************** Global Variables **************************************************************/
uint8 volatile Global_uint8RecordDataBuffer[RECORD_CHAR_NUM];
...
void HWIFI_voidInit()
{
	...
	for(Local_uint8LoopCounter = 0; Local_uint8LoopCounter < 100 ; Local_uint8LoopCounter++)
	{
...
void HWIFI_voidConnectToWifi()
{
	...
	MSYS_TICK_voidSetBusyWait(6000000);
	while(HWIFI_CommandValidation() == NOT_OK)
	{
		HWIFI_CLearDataBuffer();
...
void HWIFI_voidConnectToServer()
{
	...
	MSYS_TICK_voidSetBusyWait(300000);
	while(HWIFI_CommandValidation() == NOT_OK)
	{
		HWIFI_CLearDataBuffer();
