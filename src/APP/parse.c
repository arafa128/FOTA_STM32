...
*							Karem Hassan                                                                                              *
*							Ahmed Emad						09 MAR,2022						parse.c  							      *
**************************************************************************************************************************************/
	...
	switch(Copy_uint8RecordBuffer[8])
	{
		case '0' :
				...
				else
				{
					...
					HWIFI_VoidSendHttpRequest((uint8*)"http://fota-nc.freevar.com/Recive.php?response=Reload", (uint8*)"59");
				}
		break;
